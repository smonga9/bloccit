require 'rails_helper'
 ...
 RSpec.describe SponsoredPostsController, type: :controller do
   ...
   describe 'GET #edit' do
     it 'returns http success' do
       get :edit, params: {topic_id: topic.id, id: sponsored_post.id}
       expect(response).to have_http_status(:success)
     end
     ...
     describe 'POST create' do
       ...
       it 'assigns the new sponsored_post to @sponsored_post' do
         post :create, params: {topic_id: topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_integer }}
     ...
     describe 'PUT update' do
       it 'updates sponsored post with expected attributes' do
         ...
         put :update, params: {topic_id: topic.id, id: sponsored_post.id, sponsored_post: { title: new_title, body: new_body, price: new_price }}
     ...
     describe 'DELETE destroy' do
       it 'deletes the post' do
         delete :destroy, params: {topic_id: topic.id, id: sponsored_post.id}
